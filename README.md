...
[Read the documentation here. 📖](https://catterwaul.github.io/HemiprocneMystaceaError/documentation/hmerror/) 

## Dependency 

HemiprocneMystaceaError is in the "Major Version Zero" phase, allowing for rapid development based on community feedback. 
